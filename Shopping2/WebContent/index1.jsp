  ...
  <div class="navbar-header nav_2">
   ...
   <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
        <ul class="nav navbar-nav nav_1">
            <li><a class="color" href="index1.jsp">Home</a></li>
...
tempAddress="index1.jsp";
		...
		tempCartAddress="Login_CartProduct";
...
%>                  
					...
					<div class="pro-img">
						...
						<a class="picture" href="images/<%=resultSet.getString("img1")%>" rel="title" class="b-link-stripe b-animate-go  thickbox"><i class="glyphicon glyphicon-search icon "></i></a>
                                                <a href="FetchProduct?id=<%=resultSet.getInt("product_id")%>"><i class="glyphicon glyphicon-menu-right icon"></i></a>
						</div>
						</div>
						<div class="mid-1">
						<div class="women">
						...
						<input type="text"> 
							...
							<div class="img item_add">
								<a href="<%=tempAddress%>?productID=<%=resultSet.getInt("product_id")%>"><img src="images/ca.png" alt=""></a>
							</div>
							<div class="clearfix"></div>
							</div>
							<div class="mid-2">
