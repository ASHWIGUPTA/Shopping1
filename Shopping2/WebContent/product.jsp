 <%-- 
    Document   : product
    Created on : Jun 10, 2017, 12:28:36 AM
    Author     : puneet gupta
--%>
...
<!-- Mirrored from p.w3layouts.com/demos/shopin/web/product.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Apr 2017 19:28:40 GMT -->
<head>
...
<div class="banner-top">
	<div class="container">
		<h1>Products</h1>
		<em></em>
		<h2><a href="index-2.html">Home</a><label>/</label>Products</a></h2>
	</div>
</div>
<!---728x90--->
	<!--content-->
	...
	%>			
	 <%
	    ...
	    if(session.getAttribute("UserId")==null){                   // session Attribute Added
	         ...
	         tempAddress="index1.jsp";
	        
	        }
	        else{                                                           //Login Attribute Added
	        	  int userID=(Integer)session.getAttribute("UserId");
	        		session.setAttribute("UserId", userID);
	        		tempAddress="Login_Cart";
	        		
	        }
                                ArrayList<ProductDTO> a = null;
                                a = (ArrayList<ProductDTO>)session.getAttribute("list2");
                                session.setAttribute("list2", a);
                                if(a == null){
                                    System.out.println("now i'm null");
                                    response.sendRedirect("404.html");
                                }
                                System.out.println("i'm in product.jsp");
                                for(ProductDTO pd : a){
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="images/<%=pd.getImg_path()%>" class="img-responsive" alt="">
						<div class="zoom-icon ">
						<a class="picture" href="images/<%=pd.getImg_path()%>" rel="title" class="b-link-stripe b-animate-go  thickbox"><i class="glyphicon glyphicon-search icon "></i></a>
						<a href="FetchProduct?id=<%=pd.getId()%>"><i class="glyphicon glyphicon-menu-right icon"></i></a>
						</div>
						</div>
						<div class="mid-1">
						<div class="women">
						<div class="women-top">
							...
							<h6><a href="single.html"><%=pd.getDescr()%></a></h6>
							</div>
							<div class="img item_add">
								<a href="<%=tempAddress%>?productID=<%=pd.getId()%>"><img src="images/ca.png" alt=""></a>
							</div>
							<div class="clearfix"></div>
							</div>
							<div class="mid-2">
								<p ><em class="item_price">Rs.<%=pd.getPrice()%></em></p>
								  <div class="block">
...
<!-- Mirrored from p.w3layouts.com/demos/shopin/web/product.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Apr 2017 19:28:48 GMT -->
</html>