...
<!-- Mirrored from p.w3layouts.com/demos/shopin/web/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Apr 2017 19:28:29 GMT -->
<head>
   ...
   <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
        <ul class="nav navbar-nav nav_1">
            <li><a class="color" href="index1.jsp?productID=0">Home</a></li>
...
<div class="banner-top">
	<div class="container">
		<h1>Checkout</h1>
		<em></em>
		<h2><a href="index1.jsp?productID=0">Home</a><label>/</label>Checkout</a></h2>
	</div>
</div>
<!---728x90--->
<!--login-->
	...
	<div class="footer-middle">
				<div class="container">
					<div class="col-md-3 footer-middle-in">
						<a href="index1.jsp"><img src="images/log.png" alt=""></a>
...
<!-- Mirrored from p.w3layouts.com/demos/shopin/web/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Apr 2017 19:28:40 GMT -->
</html>